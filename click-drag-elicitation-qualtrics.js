$( document ).ready(function() {
    ...
    $( this ).before('<div style="text-align: right;"><button  class="undo btn  btn-warning mx-1"  disabled  type="button">Undo</button><button class="reset btn  btn-danger  mx-1" disabled  type="button">Reset</button><button class="normalize btn btn-primary  mx-1" style="color: #000000;"  type="button">Scale to Sum to 100</button></div>');
